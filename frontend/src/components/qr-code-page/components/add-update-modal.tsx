...
export const QR_TYPE_CONFIGS = [
  ...
  },
  {
    ...
    name: "Email",
    icon: <Mail />,
    desc: "Pre-filled email dispatcher",
  ...
  },
  {
    ...
    name: "G. Review",
    icon: <StarIcon />,
    desc: "Google review optimization",
  ...
  const onTypeChange = (value: QRType) => {
    ...
    switch (value) {
      ...
      case "SMS":
        ...
        break;
      case "WIFI":
        setValue("content", { ssid: "", password: "", encryption: "WPA2" });
        break;
      case "VCARD":
        setValue("content", {
          firstName: "",
        ...
        <div className="w-full px-6 py-5 flex-1 overflow-y-auto bg-white">
          {step === 0 && (
            <div className="space-y-5 animate-in fade-in-50 duration-150">
              <div>
                <h4 className="text-2xs font-bold tracking-wider text-gray-400 uppercase mb-3">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                  {QR_TYPE_CONFIGS.map((cfg) => (
                    <div
                      ...
                      className={`border p-3 rounded-xl flex flex-col items-center gap-2 cursor-pointer transition-all duration-200 bg-white group hover:-translate-y-0.5 hover:shadow-sm ${
                        type === cfg.id
                    ...
                    >
                      <div
                        className={`w-10 h-10 rounded-lg flex items-center justify-center text-xl shadow-inner ${cfg.bg}`}
                      >
                        {cfg.icon}
                      </div>
                      ...
                      <p className="text-3xs text-gray-400 text-center leading-tight tracking-tight px-1">
                        {cfg.desc}
                      </p>
                    </div>
                  ))}
              ...
              {showFolderOptions && (
                <div className="pt-2 border-t border-gray-100">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {folderSearchLoading && <div>Loading...</div>}
                    {!folderOptions?.length && !folderSearchLoading ? (
          ...
          {step === 1 && (
            <div className="space-y-4 animate-in fade-in-50 duration-150">
              <h4 className="text-2xs font-bold tracking-wider text-gray-400 uppercase mb-1">
                Target Structural Configuration
              </h4>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex flex-col gap-1.5 md:col-span-2">
                  <label className="text-xs font-semibold text-gray-700 tracking-wide">
                    QR Profile Display Name *
                  </label>
                  <Input
                ...
                {type === "URL" && (
                  <div className="flex flex-col gap-1.5 md:col-span-2">
                    ...
                    />
                    <span className="text-3xs text-gray-400 mt-0.5">
                      Destination target pathway metadata must validate using
                      standard security protocols TLS/HTTPS patterns.
                    </span>
                  </div>
                )}
                ...
                {type === "EMAIL" && (
                  <div className="flex flex-col gap-3 md:col-span-2">
                    <div className="flex flex-col gap-1.5">
                      ...
                      <Input
                        placeholder="corporate@workspace.io"
                        className="h-10 border-gray-200 rounded-lg"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                      ...
                      <div className="flex flex-col gap-1.5">
                        <label className="text-xs font-semibold text-gray-700 tracking-wide">
                          Pre-populated Body Context
                        </label>
                        <Input
                          placeholder="Type message frame..."
                          className="h-10 border-gray-200 rounded-lg"
                ...
                {(type === "PHONE" ||
                  ...
                  <div className="flex flex-col gap-3 md:col-span-2">
                    <div className="flex flex-col gap-1.5">
                      <label className="text-xs font-semibold text-gray-700">
                        Destination Phone Number Vector *
                      </label>
                      <Input
                    ...
                    {type !== "PHONE" && (
                      <div className="flex flex-col gap-1.5">
                        <label className="text-xs font-semibold text-gray-700">
                          Predefined Payload Message Text
                        </label>
                        <Input
                          placeholder="Hello, I want to request access permissions..."
                          className="h-10 border-gray-200 rounded-lg"
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="text-xs font-semibold text-gray-700">
                    Fallback Routing Rule Redirect Status
                  </label>
                  <Select
                    defaultValue="ACTIVE"
                  ...
                  >
                    ...
                    <SelectContent>
                      <SelectItem value="ACTIVE">
                        Direct Live Redirect (Active)
                      </SelectItem>
                      <SelectItem value="PAUSED">
                        Hold Routing Rules (Paused / Inactive)
                      </SelectItem>
                    </SelectContent>
                  </Select>
                </div>
          ...
          {step === 2 && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 animate-in fade-in-50 duration-150">
              <div className="space-y-4">
                <div>
                  <h4 className="text-2xs font-bold tracking-wider text-gray-400 uppercase mb-2">
                    QR Vector Core Palette
                  </h4>
                  <div className="flex items-center gap-2 flex-wrap">
                    {[
                      ...
                      <div
                        ...
                        className={`w-7 h-7 rounded-lg cursor-pointer transition-transform relative ${
                          qrColor === color
                ...
                <div>
                  <h4 className="text-2xs font-bold tracking-wider text-gray-400 uppercase mb-2">
                    Export Vector Canvas Dimension
                  </h4>
                  <div className="flex gap-2">
                    {["300px", "600px", "1200px", "SVG"].map((size) => (
                      <button
                        ...
                        className={`text-xs px-3 py-1.5 rounded-lg border font-medium flex-1 transition-all text-center ${
                          exportSize === size
                ...
                <div>
                  <h4 className="text-2xs font-bold tracking-wider text-gray-400 uppercase mb-1.5">
                    Centerpiece Watermark Overlay
                  </h4>
                  <div className="border border-dashed border-indigo-200 rounded-xl p-3 text-center cursor-pointer bg-indigo-50/20 group hover:bg-indigo-50/40 transition-colors">
                    ...
                    <span className="text-xs font-semibold text-indigo-700 block">
                      Drop asset workspace logo here
                    </span>
                    <span className="text-3xs text-gray-400">
                      Supports transparent alpha channel PNG or SVG (Max 2MB)
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col">
                ...
                <div className="flex-1 bg-slate-50 border border-dashed border-indigo-100 rounded-2xl p-5 flex flex-col items-center justify-center gap-3">
                  ...
                  >
                    <span
                      style={{ color: qrColor }}
                      className="text-6xl select-none font-light"
                    >
                      ⬡
                    </span>
                  ...
                  <p className="text-3xs text-gray-400 text-center px-4 leading-tight">
                    Rasterization modifications modify paths instantly.
                    Real-time configuration validation pipeline status.
                  </p>
                  <div className="flex gap-1.5 w-full max-w-xs mt-1">
                    <Button
                      type="button"
                      variant="outline"
                      className="h-7 text-3xs font-medium bg-white flex-1 rounded-md shadow-2xs"
                    >
                      ⬇ PNG
                    </Button>
                    <Button
